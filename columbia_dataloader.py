...
class GazeDataset(Dataset):
    def __init__(self, dataset_path: str, keys_to_use: List[str] = None, sub_folder='', transform=None, is_shuffle=True,
        ...
        self.n = n
        self.target_idx = np.loadtxt("columbia_evaluation_target_single_subject.txt", dtype=np.int)
    ...
    def __getitem__(self, idx):
        ...
        self.hdf_nerf = h5py.File(os.path.join(self.path,"columbia_" + self.selected_keys[key]), 'r', swmr=True) #TODO check the path
